...
parser.add_argument("--model_name", default = "pan_model", help = "Prefix of the saved model", type = str)
...
batch_size = int(args.batch_size) #Default batch size
...
from nettcr_archs import CNN_CDR123_global_max
...
model = CNN_CDR123_global_max(dropout_rate, seed)
